...
def plot_gsr_data(filepath: str, save_path: Optional[str] = None):
    from analysis import plot_gsr_data as _plot
    return _plot(filepath, save_path=save_path)


def plot_gsr_analysis(filepath: str, window_size: float = 5.0, save_path: Optional[str] = None):
    from analysis import plot_gsr_analysis as _plot
    return _plot(filepath, window_size=window_size, save_path=save_path)
